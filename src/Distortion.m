...
%   TONE - -1 para tons baixo, 1 para agudos (um polo no filtro passa banda)
%     FS - Frequência de Amostragem
    ...
    b=in;
    b=b/max(abs(b)); % normalização do sinal valor absoluto máximo
    b=gain*b; % ganho
    ...
    % parabola para conectar regiões lineares e saturadas
    ...
    [BL,AL]=zp2tf(ZL,PL,KL); % calcula a função de transferência
    [BH,AH]=zp2tf(ZH,PH,KH); % funçãoo de transferência
